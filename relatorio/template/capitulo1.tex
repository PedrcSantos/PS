...
Texto da secção. Na figura~\ref{fig:logotipo} mostra-se o logotipo do ISEL. Em \cite{wiki:bigdata2015} encontra várias referências para o assunto. O artigo \cite{6547630} é o mais popular conforme indicação do IEEE. Logo a seguir aparece \cite{6824752}. A identificação das referências deve ser melhorada.
...
\end{center}
\caption{Legenda da figura com o logotipo do ISEL.}\label{fig:logotipo}
\end{figure}
